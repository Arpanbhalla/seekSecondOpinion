...
User.destroy_all
u1 = User.create :username => "Arpan Bhalla", :firstname => "Arpan", :lastname => "Bhalla", :email => "arpan@ga.com", :dob => '3/9/1984', :password => "chicken", :password_confirmation => "chicken", :admin => true
